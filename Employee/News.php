...
require_once('./Employee/Database/connect.php');
...
if (isset($_POST['subject'])) {
    ...
    if (empty($subject) || empty($message)) {
        ...
        try {
            ...
            $mail->SMTPAuth = true;
            $mail->Username = 'compssa10@gmail.com';
            $mail->Password = 'tvje mbaq usqz filg ';
            $mail->Port = 587;
            $mail->FromName = "Travel & Tour";
            $mail->SMTPSecure = 'tls';

            // Set 'From' email address
            $mail->setFrom('compssa10@gmail.com');
