    ...
    <div class="container-fluid position-relative p-0">
        <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <div class="dropdown">
                    <a class="btn btn-primary rounded-pill py-2 px-4 dropdown-toggle" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <i class="fa fa-user-alt me-2" style="color:white;"></i>
                    </a>
                    <div class="dropdown-menu  p-2 shadow" aria-labelledby="dropdownMenuButton" style="border-radius:8%;">
                        <a class="dropdown-item d-flex align-items-center" href="/signup.php">
                            <i class="fa fa-user-alt me-2"></i>Login/Signup
                        </a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item d-flex align-items-center" href="#">
                            <i class="fa fa-heart me-2"></i>Whitelist
                        </a>
                        <a class="dropdown-item d-flex align-items-center" href="#">
        ...
        <div class="container-fluid bg-primary py-5 mb-5 Book">
            <div class="container py-5">
                <div class="row justify-content-center py-5">
                    <div class="col-lg-10 pt-lg-5 mt-lg-5 text-center">
                        <h1 class="display-3 text-white mb-3 animated slideInDown">Let get your booking with ease</h1>
                        ...
                        <div class="position-relative w-75 mx-auto animated slideInDown">
                            <input class="form-control border-0 rounded-pill w-100 py-3 ps-4 pe-5" type="text" placeholder="Eg: HO">
