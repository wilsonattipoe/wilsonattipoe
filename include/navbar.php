                ...
                <div class="navbar-nav ms-auto py-0 align-items-center">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <?php else: ?>
                            ...
                            <a class="nav-link dropdown-toggle" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p>You can also visit our <a href="#">FAQ page</a> for common questions and answers.</p>
                    </div>
