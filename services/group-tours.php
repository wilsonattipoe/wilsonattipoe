...
<div id="booking" class="content-section" style="margin: 15px;">
  <h1 class="text-center">Group  tour</h1> 
</div>
                ...
                let tourHtml = `<div class="tour-container">
                    ...
                    <div class="card-body">
                        ...
                        <div class="text-right">
                                <button class="btn btn-primary btn-sm" onclick="checkLoginAndShowCartModal(${tour['tourservices_id']});">
                                    <i class="fas fa-cart-plus"></i> Add to Cart
                                </button>
                                <button class="btn btn-outline-danger btn-sm" onclick="checkLoginAndShowBookModal(${tour['tourservices_id']});">
