    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-outline-success w-20" data-dismiss="modal">Close</button>
                <button type="submit" class="btn btn-outline-danger" onclick="BookTour()">Book now</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    function BookTour() {
        console.log("BookTour function called");
        var id = $('#book_id').val();
